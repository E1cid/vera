...
-- edit appended opt to end of password
	local password = getVar("Password", "", masterID, MYSID)  ..  getVar("OneTimePassCode", "", masterID, MYSID)
...
function startPlugin(devNum)
 ...
 -- added OneTimePassCode Variable
	initVar(MYSID, "OneTimePassCode", "", devNum)

	-- init default values for Uk
	initVar(MYSID, "Language", "en-uk", devNum)
	initVar(MYSID, "AlexaHost", "layla.amazon.co.uk", devNum)
